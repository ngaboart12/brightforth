      ...
      <div className="flex flex-col w-full">
        ...
        <div className="grid gap-4 grid-cols-4 w-full">
          <Input
            ...
            type="text"
            value={formData.stage2.input1}
            onChange={(e) =>
              handleInputChange("stage2", "input1", e.target.value)
            }
          />
          <Input
          ...
          <Input
            ...
            type="text"
          />
          <Input placeholder="Enter date" label="Valid To" type="date" />
        </div>
      </div>
      <div className="flex flex-col w-full">
        <h1 className="text-black font-[600] text-[18px]">Address</h1>
        <div className="grid gap-4 grid-cols-4 w-full">
          <Input placeholder="Select Country" label="Country" type="text" />
          <Input
