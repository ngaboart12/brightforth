...
import specialhero1 from "../../assets/specialhero1.png";
      ...
      <div className="w-[70%]  px-[38px] py-[10px] bg-black bg-opacity-25 rounded-xl backdrop-blur-[5px] justify-center items-center inline-flex">
        <div className="self-stretch justify-start items-start gap-[46px] flex flex-col md:flex-row">
          <div className="justify-start items-center gap-4 flex">
            <img className="w-[86px] rounded-[14px]" src={specialhero1} />
            <div className="flex-col justify-start items-start gap-2 inline-flex">
              <div className="text-center text-amber-500 text-2xl font-normal font-['Outfit']">
                Special Offers
              </div>
              <div className="  text-white text-[16px] font-[200] font-['Outfit'] line-clamp-2 leading-5">
          ...
          <div className="justify-start items-center gap-4 flex">
            ...
            <div className="flex-col justify-start items-start gap-2 inline-flex">
              ...
              <div className="font-[200] text-white text-[16px] line-clamp-2  font-['Outfit'] leading-5">
                Personal burnt tomato bbq mouth garlic spinach lasagna beef.
                Pizza olives banana rib bacon.
              </div>
            </div>
