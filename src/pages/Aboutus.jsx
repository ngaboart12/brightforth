              ...
              <div class="flex-col justify-start items-start gap-4 flex">
                <div class="justify-start items-start gap-2 inline-flex">
                  <div class="flex-col justify-start items-start gap-2 inline-flex">
                    <div class="text-yellow-400 text-2xl font-bold font-['Outfit']">
                      4,500
                    </div>
                    <div class="w-[140px] text-slate-400 text-sm font-normal font-['Outfit']">
                      Total Students
                    </div>
                  </div>
                  <div class="flex-col justify-start items-start gap-2 inline-flex">
                ...
                <div class="justify-start items-start gap-2 inline-flex">
                  ...
                  <div class="flex-col justify-start items-start gap-2 inline-flex">
                    ...
                    <div class="w-[100px] leading-3 text-slate-400 text-sm font-normal font-['Outfit']">
                      Available Programs
                    </div>
                  </div>
                </div>
      ...
      <div className="max-w-7x w-full px-[] md:px-40 flex flex-col gap-20 py-20">
        <div className="flex w-full flex-col-reverse md:flex-row justify-between gap-10 items-center">
          <div className="w-full md:w-1/2 h-[250px]">
            <img src={member1} alt="" className="w-full h-full object-cover" />
          </div>
