  ...
  return (
    <div className="flex flex-col items-center justify-center  w-full pb-10 ">
      ...
      <div className="flex flex-col gap-5 pt-[83px] items-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-x-[40px] gap-y-6">
      ...
      <div className=" flex  justify-center items-center py-20 w-full px-2 md:px-20">
        <div className="flex max-w-7xl  flex-col md:flex-row md:justify-between gap-10 bg-[#07294D] rounded-[24px] py-12 px-3 md:p-20">
      ...
      <div className="flex flex-col gap-6 max-w-7xl py-20">
        <h1 className="text-[32px] text-[#07294D] font-bold text-center">
          React Out To Us
        </h1>
        <div className="flex flex-col gap-10 md:flex-row">
          <div className="flex flex-col gap-4">
            <div className=" flex flex-col gap-5dd">
          ...
          <div className="flex flex-col">
            <form action="" className="flex flex-col gap-4 px-10">
