  ...
  return (
    <div className="flex flex-col items-center justify-center  w-full">
      ...
      <div className="flex px-[20px] md:px-40 flex-col gap-4 py-10 w-full max-w-7xl items-center">
        <div class="text-center text-sky-900 text-[20px] md:text-[40px] font-bold font-['Outfit']">
        ...
        <div class="w-full ] flex-col justify-start items-center gap-[34px] inline-flex">
          <div class="pl-14 pr-[57px] pt-[11px] pb-3 bg-orange-100 rounded-lg justify-center items-center inline-flex">
            <div class="text-amber-500 text-xl font-medium font-['Outfit']">
              Step ONE
            </div>
          </div>
          <div class="max-w-[511px] text-center text-sky-900 text-2xl font-semibold font-['Outfit']">
            ...
            <div class="w-full md:w-1/2 flex-col justify-start items-start gap-6 inline-flex">
              <div class="flex-col justify-start items-start gap-4 flex">
                <div class="justify-start items-start gap-2 inline-flex">
                  <div class="justify-start items-start gap-2 flex">
                    <div class="w-[30px] text-black text-lg font-normal font-['Outfit']">
                      A
                    </div>
                  </div>
                  <div class="flex-col justify-start items-start gap-2 inline-flex">
                    <div class="max-w-[364px] text-black text-lg font-medium font-['Outfit']">
                      The Application Form
                    </div>
                    <div class="max-w-[364px] text-zinc-600 text-lg font-normal font-['Outfit']">
              ...
              <div class="flex-col justify-start items-start gap-4 flex">
                <div class="justify-start items-center gap-2 inline-flex">
                  ...
                  <div class="max-w-[364px] text-black text-lg font-normal font-['Outfit']">
                    Copy of passport
                  </div>
                </div>
              </div>
            ...
            <div class="w-full md:w-1/2  flex-col justify-start items-start gap-4 inline-flex">
              ...
              <div class="flex-col justify-start items-start gap-4 flex">
                <div class="justify-start items-start gap-2 inline-flex">
                  ...
                  <div class="flex-col justify-start items-start gap-2 inline-flex">
                    <div class="max-w-[395px] text-black text-lg font-medium font-['Outfit']">
      ...
      <div className="flex  flex-col gap-6 w-full items-center max-w-7xl py-10 px-[20px] md:px-40">
        <div className="w-[200px] h-12 pl-14 pr-12 pt-[11px] pb-3 bg-orange-100 rounded-lg justify-end items-center inline-flex">
          <div className="text-amber-500 text-xl font-medium font-['Outfit']">
            Step TWO
          </div>
        </div>
        ...
        <div className="flex flex-col gap-8 py-10">
          <h1 className="text-center text-sky-900 text-2xl font-semibold font-['Outfit']">
      ...
      <div className="flex  flex-col gap-6 w-full items-center max-w-7xl py-10 px-[20px] md:px-40">
        <div className="w-[200px] h-12 pl-14 pr-[43px] pt-[11px] pb-3 bg-orange-100 rounded-lg justify-end items-center inline-flex">
          <span className="text-amber-500 text-xl font-medium font-['Outfit']">
            Step Three
          </span>
        </div>
